...
__all__ = [ 'IFontEventsDisp', 'Checked', 'OLE_CANCELBOOL',
           'OLE_ENABLEDEFAULTBOOL', 'FONTITALIC',
           'OLE_XPOS_CONTAINER', 'Default', 'FONTSTRIKETHROUGH',
           'OLE_XSIZE_PIXELS', 'IPictureDisp', 'Font', 'IFontDisp',
           'FONTUNDERSCORE', 'FONTBOLD', 'OLE_HANDLE', 'StdPicture',
           'OLE_COLOR', 'FONTSIZE', 'Unchecked', 'OLE_YPOS_HIMETRIC',
           'OLE_XSIZE_CONTAINER', 'Picture', 'OLE_OPTEXCLUSIVE',
           'IPicture', 'OLE_YPOS_PIXELS', 'Monochrome',
           'OLE_YSIZE_HIMETRIC', 'Color', 'OLE_YPOS_CONTAINER',
           'OLE_XPOS_PIXELS', 'FONTNAME', 'OLE_YSIZE_PIXELS', 'Gray',
           'StdFont', 'OLE_XSIZE_HIMETRIC', 'IFont', 'VgaColor',
           'LoadPictureConstants', 'OLE_TRISTATE',
           'OLE_XPOS_HIMETRIC', 'FontEvents', 'OLE_YSIZE_CONTAINER']
from comtypes import _check_version; _check_version('1.1.11', 1651900738.765207)
